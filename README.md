...
[`fenics_jupyter.py`](https://raw.githubusercontent.com/unifem/fenics-desktop/master/fenics_jupyter.py)
...
```
curl https://raw.githubusercontent.com/unifem/fenics-desktop/master/fenics_jupyer.py -outfile fenics_jupyer.py
```
On Linux or Mac, start a terminal, use the `cd` command to change to the working directory, and then run the following command:
```
curl -s -O https://raw.githubusercontent.com/unifem/fenics-desktop/master/fenics_jupyer.py
```

After downloading the script, you can start the Docker image using the command
```
python fenics_jupyer.py -p
```
...
```
python fenics_jupyter.py -h
```

### Running the Docker Image with Desktop Environment
Besides using the Docker Image as a Jupyter Notebook server, you can also start it in an X-Windows desktop environment. Simply replace `fenics_jupyter.py` with `fenics_desktop.py` in the preceding commands. That is, on Windows use the following commands in the PowerShell:
```
curl https://raw.githubusercontent.com/unifem/fenics-desktop/master/fenics_desktop.py -outfile fenics_desktop.py
python fenics_desktop.py -p
```
and on Linux and Mac use the following commands in a terminal:
```
curl -s -O https://raw.githubusercontent.com/unifem/fenics-desktop/master/fenics_desktop.py
python fenics_desktop.py -p
```
...
```
python fenics_jupyter.py
```
or
```
python fenics_desktop.py
```
